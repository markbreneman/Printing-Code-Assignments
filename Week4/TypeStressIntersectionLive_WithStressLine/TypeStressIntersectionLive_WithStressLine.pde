...
RShape cuttingLine0;//Letter1 Axis
RShape cuttingLine1;//Letter1 Axis
RShape cuttingLine2;//Letter1 Axis
RShape cuttingLine3;//Letter1 Axis
RShape cuttingLine4;//Letter1 Axis
RShape cuttingLine5;//Letter1 Axis
...
//  ellipse(0,0,19,19);
  ...
  for (int j=0; j<s0IntPoints.length; j++) { 
          ...
          if (int(s0Points[i].x) <= int(s0IntPoints[j].x+10) && int(s0Points[i].x) >= int(s0IntPoints[j].x-10) && int(s0Points[i].y) <= int(s0IntPoints[j].y+10) && int(s0Points[i].y) >= int(s0IntPoints[j].y-10)) {
...
//  ellipse(0,0,19,19);
  ...
  for (int j=0; j<tIntPoints.length; j++) { 
          ...
          if (int(tPoints[i].x) <= int(tIntPoints[j].x+10) && int(tPoints[i].x) >= int(tIntPoints[j].x-10) && int(tPoints[i].y) <= int(tIntPoints[j].y+10) && int(tPoints[i].y) >= int(tIntPoints[j].y-10)) {
...
//  ellipse(0,0,19,19);
  ...
  for (int j=0; j<rIntPoints.length; j++) { 
          ...
          if (int(rPoints[i].x) <= int(rIntPoints[j].x+10) && int(rPoints[i].x) >= int(rIntPoints[j].x-10) && int(rPoints[i].y) <= int(rIntPoints[j].y+10) && int(rPoints[i].y) >= int(rIntPoints[j].y-10)) {
...
//  ellipse(0,0,19,19);
  ...
  for (int j=0; j<eIntPoints.length; j++) { 
          ...
          if (int(ePoints[i].x) <= int(eIntPoints[j].x+10) && int(ePoints[i].x) >= int(eIntPoints[j].x-10) && int(ePoints[i].y) <= int(eIntPoints[j].y+10) && int(ePoints[i].y) >= int(eIntPoints[j].y-10)) {
...
//  ellipse(0,0,19,19);
 ...
 fill(0,100,0,1);
  ...
  for (int j=0; j<s1IntPoints.length; j++) { 
          ...
          if (int(s1Points[i].x) <= int(s1IntPoints[j].x+10) && int(s1Points[i].x) >= int(s1IntPoints[j].x-10) && int(s1Points[i].y) <= int(s1IntPoints[j].y+10) && int(s1Points[i].y) >= int(s1IntPoints[j].y-10)) {
...
fill(0,100,0,1);
  ...
  for (int j=0; j<s2IntPoints.length; j++) { 
          ...
          if (int(s2Points[i].x) <= int(s2IntPoints[j].x+10) && int(s2Points[i].x) >= int(s2IntPoints[j].x-10) && int(s2Points[i].y) <= int(s2IntPoints[j].y+10) && int(s2Points[i].y) >= int(s2IntPoints[j].y-10)) {
