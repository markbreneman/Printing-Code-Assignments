...
// 2D SLIDER for TARGET  
  ...
  nameTarget = controlP5.addSlider2D("TitlePlacement", 0, gridN1Cols-1, 0, gridN1Rows-1, gridN1Cols/2, gridN1Rows/2, 120, 10, 100, 100);
  nameTarget.setArrayValue(new float[] {
    (gridN1Cols-1)/2, (gridN1Rows-1)/2
  }
  );  
  nameTarget.setWindow(controlWindow);
...
//  ///TITLE SIZE
//  S1 = controlP5.addSlider("titleSize", 100, 280, 1485, 240, 10, 100, 10);
//  S1.setNumberOfTickMarks(180);
//  S1.setSliderMode(Slider.FLEXIBLE);
//  S1.setWindow(controlWindow);
//  
  ///TAGLINE SIZE
//  S2 = controlP5.addSlider("taglineSize", 0, 200, 212, 240, 40, 100, 10);
//  S2.setNumberOfTickMarks(200);
//  S2.setSliderMode(Slider.FLEXIBLE);
//  S2.setWindow(controlWindow);
  
  ///DETAILS SIZE
//  S3 = controlP5.addSlider("detailsSize", 0, 200, 236, 240, 80, 100, 10);
//  S3.setNumberOfTickMarks(200);
