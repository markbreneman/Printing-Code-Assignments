...
float paper_width = 5.875;
float paper_height = 9;
...
//  details = "YALE UNION CONTEMPORARY | PORTLAND, OR | SEPTEMBER 13-16 2013";
  detailsPos=new PVector(gridN1.modules[gridN1Cols-1][0].x+gridN1.modules[gridN1Cols-1][0].w, gridN1.modules[0][gridN1Rows-1].y+gridN1.modules[0][gridN1Rows-1].h*3.5);
  detailsSize=150;  
...
void draw() {
  ...
  canvas.noStroke();
  canvas.fill(c5);
  //MASKING RECTANGLE: HARDCODED -10 & 10 ARE TO ENSURE STROKE COVERAGE
  canvas.rect(
  titlePos.x-10, 
  titlePos.y+gridN1.modules[0][0].h*3+gridN1Gutter*2+10,
  gridN1.modules[0][0].w*9+gridN1Gutter*9, 
  -gridN1.modules[0][0].h*8-gridN1Gutter*8
  ); 
